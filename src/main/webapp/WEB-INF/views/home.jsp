   ...
   <div class="d-flex text-light">
        <div class="col-md-8 col-xs-12 pt-5 mt-4">
            <div class="col-md-7 col-xs-12 mx-auto px-3 slogan">
                ...
                <h1 class="text-justify fw-bold mt-2">Browse Affordable Homes/Rooms for Rent everywhere.</h3>
                <h4 class="text-justify fw-lighter mt-4">Relocating can be a scary thing especially when you don't have a place to stay... but we got you covered. <span class="h2 fst-italic fw-bold"> B4R </span>let's you connect to home owners, browse & search available rooms or houses for rent within a specific area or location. </h4>
