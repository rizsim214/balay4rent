    ...
    <div class="col-md-12">
        <form action="" method="post">
            <div class=" d-flex justify-content-center align-items-center flex-column mt-5">
                <p class="display-3 text-light fw-bold text-capitalize mb-3"> Find a place to stay </p>
                <input type="text" name="search" class="form-control search-box py-4 px-5 my-3" placeholder="Where do you like to stay?">
